...
def normalize_targets(id_target, target_idx):
    targets = id_target[:, target_idx]
    targets_min = numpy.min(targets)
    targets_max = numpy.max(targets)

    return (targets - targets_min) / (targets_max - targets_min)
